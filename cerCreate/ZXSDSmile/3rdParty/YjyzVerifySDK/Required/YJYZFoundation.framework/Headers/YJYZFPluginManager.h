 ...
 *  @return 插件对象
 */
typedef id<IYJYZFPlugin>(^YJYZFPluginConstructHandler) ();

/**
 *  插件管理器
 */
@interface YJYZFPluginManager : NSObject
 ...
 */
- (BOOL)registerPlugin:(YJYZFPluginConstructHandler)pluginConstructHandler forKey:(NSString *)key;
 ...
 */
- (id<IYJYZFPlugin>)pluginForKey:(NSString *)key;
