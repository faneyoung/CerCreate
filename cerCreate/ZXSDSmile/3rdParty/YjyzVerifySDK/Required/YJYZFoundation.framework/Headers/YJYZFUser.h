...
//  YJYZFoundation
//
//  Created by yjyz on 17/3/17.
//  Copyright © 2017年 YJYZ. All rights reserved.
//

#import <YJYZFoundation/YJYZFoundation.h>
#import "IYJYZBaseUser.h"
#import "YJYZFDataModel.h"

/**
 用户信息
 */
@interface YJYZFUser : YJYZFDataModel <IYJYZBaseUser>
...
/**
 ...
 @return 用户信息
 */
+ (YJYZFUser* _Nullable)userWithUid:(NSString * _Nonnull)uid
...
/**
 ...
 @return 用户信息
 */
+ (YJYZFUser* _Nullable)userWithAppUid:(NSString * _Nonnull )appUid
                               avatar:(NSString * _Nullable)avatar
