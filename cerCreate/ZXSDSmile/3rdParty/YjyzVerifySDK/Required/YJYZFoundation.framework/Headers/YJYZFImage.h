 ...
 *  圆角类型
 */
typedef NS_ENUM(NSUInteger, YJYZFOvalType)
{
    /**
     *  无圆角
     */
    YJYZFOvalTypeNone = 0x00,
    /**
     *  左上角
     */
    YJYZFOvalTypeLeftTop = 0x01,
    /**
     *  左下角
     */
    YJYZFOvalTypeLeftBottom = 0x02,
    /**
     *  右上角
     */
    YJYZFOvalTypeRightTop = 0x04,
    /**
     *  右下角
     */
    YJYZFOvalTypeRightBottom = 0x08,
    /**
     *  全部
     */
    YJYZFOvalTypeAll = YJYZFOvalTypeLeftTop | YJYZFOvalTypeLeftBottom | YJYZFOvalTypeRightTop | YJYZFOvalTypeRightBottom
};

/**
 *  图像工具类
 */
@interface YJYZFImage : NSObject
...
+ (UIImage *)roundRectImage:(UIImage *)image
                 ...
                 ovalHeight:(CGFloat)ovalHeight
                   ovalType:(YJYZFOvalType)ovalType;
