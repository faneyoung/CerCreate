...
//  YJYZFoundation
//
//  Created by yjyz on 17/2/16.
//  Copyright © 2017年 YJYZ. All rights reserved.
//

#import <Foundation/Foundation.h>

@class YJYZFLogService;


/**
 日志服务协议
 */
@protocol YJYZFLogServiceDelegate <NSObject>
 ...
 */
- (BOOL)logService:(YJYZFLogService *)logService
 ...
 */
- (void)logService:(YJYZFLogService *)logService
...
/**
 日志服务
 */
@interface YJYZFLogService : NSObject

/**
 委托对象
 */
@property (nonatomic, weak) id<YJYZFLogServiceDelegate> delegate;
