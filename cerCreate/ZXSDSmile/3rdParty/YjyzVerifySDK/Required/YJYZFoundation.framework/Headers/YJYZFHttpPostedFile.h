 ...
 *	@brief	HTTP上传文件
 */
@interface YJYZFHttpPostedFile : NSObject
 ...
 *	@return	上传文件信息
 */
+ (YJYZFHttpPostedFile *)httpPostedFileByFileName:(NSString *)fileName
                                           data:(NSData *)data
 ...
 *	@return	上传文件信息
 */
+ (YJYZFHttpPostedFile *)httpPostedFileByPath:(NSString *)path
                                contentType:(NSString *)contentType;
