...
// 屏幕大小、宽、高
#ifndef BR_SCREEN_BOUNDS
#define BR_SCREEN_BOUNDS [UIScreen mainScreen].bounds
#endif
#ifndef BR_SCREEN_WIDTH
#define BR_SCREEN_WIDTH [UIScreen mainScreen].bounds.size.width
#endif
#ifndef BR_SCREEN_HEIGHT
#define BR_SCREEN_HEIGHT [UIScreen mainScreen].bounds.size.height
#endif
...
// 等比例适配系数
#ifndef kScaleFit
#define kScaleFit (BR_IS_IPHONE ? ((BR_SCREEN_WIDTH < BR_SCREEN_HEIGHT) ? BR_SCREEN_WIDTH / 375.0f : BR_SCREEN_WIDTH / 667.0f) : 1.1f)
#endif
...
// 底部安全区域远离高度
#define BR_BOTTOM_MARGIN ((CGFloat)(BR_IS_iPhoneX ? ((BR_SCREEN_WIDTH < BR_SCREEN_HEIGHT) ? 34 : 21) : 0))
